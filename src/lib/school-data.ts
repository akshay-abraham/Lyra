...
const girideepamTeachersUnsorted = [
    ...
    'Mrs. Deepamol M G', 'Mrs. Girija C B', 'Mrs. Helin Felix', 'Mrs. Indu Thomas', 
    'Mrs. Jeena Ajith', 'Mr. Jerin Mathew', 'Mrs. Jisha Girish', 'Mrs. Lainy Elizabeth Chacko', 
    'Mrs. Latha Devi', 'Mrs. Lathan J Elizabeth', 'Mrs. Letha A R', 'Mrs. Manju P James', 
    'Mrs. Maya Devi', 'Mrs. Molly K V', 'Mrs. Nandini R Nair', 'Mrs. Neethu Rose Sebastian', 
    'Mrs. Niji Vinod', 'Mrs. Nimmy Merin Alex', 'Mrs. Nisha James', 'Mrs. Nizy Abraham', 
    'Mr. P.S. Jolly', 'Mrs. Prema Sara Cherian', 'Mrs. Pretha Korah', 'Mr. Ramachandran Nair', 
    'Mrs. Raymol Joseph', 'Mrs. Rekha M R', 'Mrs. Remia R', 'Mr. Retheesh', 'Mr. Rishikesh Babu', 
    'Mrs. Rosamma Mathew', 'Mrs. Ruby Maria George', 'Mrs. Sajeena G Nair', 'Mrs. Sajimol Cherian', 
    'Mrs. Shyama P Thankappan', 'Mrs. Siji Simon', 'Mrs. Smithamol N Nair', 'Mrs. Sreeja K Nair', 
    'Mrs. Sreedevi P V', 'Mrs. Vineetha Kumary'
];

const girideepamTeachers = girideepamTeachersUnsorted.sort((a, b) => {
    const nameA = a.replace(/^(Mr|Mrs)\.\s/, '');
    const nameB = b.replace(/^(Mr|Mrs)\.\s/, '');
