...
/**
 * @fileoverview Reusable Google Logo Component (`google-logo.tsx`).
 * @copyright Copyright (C) 2025 Akshay K Rooben Abraham. All rights reserved.
 *
 * @description
 * This component encapsulates the complex, colored SVG for the Google "G" logo.
 * Creating a separate component for this SVG makes the code in components that use it
 * (like the login form) much cleaner and easier to read. It also makes the logo
 * reusable across the application if needed elsewhere.
 */

/**
 * Renders the detailed Google logo SVG.
